...
RecipeIngredient.create(recipe_id: 2, ingredient_id: 3, quantity: 1)
RecipeIngredient.create(recipe_id: 2, ingredient_id: 4, quantity: 1)
RecipeIngredient.create(recipe_id: 2, ingredient_id: 5, quantity: 1)
RecipeIngredient.create(recipe_id: 3, ingredient_id: 6, quantity: 1)
RecipeIngredient.create(recipe_id: 3, ingredient_id: 7, quantity: 1)
RecipeIngredient.create(recipe_id: 3, ingredient_id: 8, quantity: 1)
RecipeIngredient.create(recipe_id: 4, ingredient_id: 9, quantity: 1)
RecipeIngredient.create(recipe_id: 4, ingredient_id: 10, quantity: 1)
RecipeIngredient.create(recipe_id: 5, ingredient_id: 11, quantity: 2)
